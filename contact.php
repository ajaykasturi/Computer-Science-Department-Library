          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <h4 class="mb-0 text-dark">Contact Us</h4>
              </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="card mb-3 me-2 border-top border-primary">
                        <div class="card-body">
                        HoD Computer Science and Engineering<br>
                        Rajiv Gandhi University of Knowledge Technologies Basar</br>
                        Nirmal, Telangana</br>
                        PIN - 504107<br>
                        email: hod.cse@rgukt.ac.in
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="card mb-3 border-top border-primary">
                        <div class="card-body">
                            CSE Department Library<br>
                            Ground floor ,CSE Department Block<br>
                            Rajiv Gandhi University of Knowledge Technologies Basar<br>
                            Nirmal, Telangana</br>
                            PIN - 504107<br>
                        </div>
