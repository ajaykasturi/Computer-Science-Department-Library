...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/bookmanagement.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative border-radius-lg ">
    <!-- Navbar -->
    <?php
    if(isset($_GET['redcode']) && $_GET['redcode']=="true"){
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Books Manager</li>
          </ol>
                ...
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Author</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Count</th>
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                          ...
                          <td>
                            <div class="d-flex px-2 py-1">
                              ...
                              <h6 class="mb-0 text-sm">'.$row["book_author"].'</h6>
                              </div>
                            </div>
                          </td>
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-success">'.$row["book_count"].'</span>
                          </td>
                          <td class="align-middle text">
                            <span type="button" class="badge badge-sm bg-gradient-primary edit" id='.$row["book_id"].'>Edit</span>
                            <span type="button" class="badge badge-sm bg-gradient-danger delete" id=d'.$row["book_id"].'>Delete</span>
                          </td>
                        </tr>';
                        }
                      }
  ...
  <script>
    ...
    Array.from(edits).forEach((element)=>{
      element.addEventListener('click',function(e){
        ...
        let id = tr.getElementsByTagName('td')[0].childNodes[1].innerText;
