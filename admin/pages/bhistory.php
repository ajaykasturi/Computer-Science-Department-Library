...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/bhistory.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">History</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Admin Login History</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4 p-3">
            <div class="card-header pb-0">
              <h6><u>Admin Session History</u></h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    <tr>
                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">S.NO</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9 ps-2">Admin</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">LogIn Date</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">LogOut Date</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Session Duration</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      if($numRows>0)
                      {
                        ...
                        {
                          $counter+=1;
                          $start_datetime = new DateTime($row['login_date']);
                          $end_datetime = new DateTime($row['logout_date']);

                          $duration = $end_datetime->diff($start_datetime);

                          $total = $duration->format('%H hours, %i minutes, %s seconds');
                          
                          echo '<tr>
                          <td>
                          <h6 class="text-center mb-0 text-sm">'.$counter.'</h6>
                          </td>
                          <td>
                          <h6 class="text-center mb-0 text-sm">'.$row["username"].'</h6>
                          </td>
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-secondary">'.$row["login_date"].'</span>
                          </td>
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-secondary">'.$row["logout_date"].'</span>
                          </td>
                          <td>
                          <h6 class="text-center mb-0 text-sm">'.$total.'</h6>
                          </td>
                        </tr>';
                        }
                      }
