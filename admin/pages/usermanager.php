...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/usermanager.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
      ...
      <strong>Your Query Updated Successfully</strong>
                ...
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    ...
                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">S.No</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9 ps-2">Username</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Email</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Created On</th>
                    ...
                    <?php
                      ...
                      if($numRows>0)
                      {
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                          ...
                          <td>
                          <h6 class="text-center mb-0 text-sm">'.$row["email"].'</h6>
                          </td>
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-success">'.$row["timestamp"].'</span>
                          </td>
                          <td class="text-center align-middle text">
                            <span type="button" class="badge badge-sm bg-gradient-primary edit" id='.$row["username"].'>View / Edit</span>
                          </td>
                        </tr>';
                        }
                      }
      ...
      Array.from(deletes).forEach((element)=>{
        element.addEventListener('click',function(e){
          ...
          if(confirm("Are you sure, you want to delete this book!")){
            ...
            formdel.method = 'post';
            formdel.action = '../admincomponents/_handledelete.php';
