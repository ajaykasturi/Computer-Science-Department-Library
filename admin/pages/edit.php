    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Edit Book</h6>
        </nav>
      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1">
                <?php echo "Title: ".$row['book_title'];?>
              </h5>
              <p class="mb-0 font-weight-bold text-sm">
                <?php echo "Author(s): ".$row['book_author'];?>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="../admincomponents/_handleedit.php" method="post">
              <input type="hidden" name="bid" value="<?php echo $id; ?>">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Title</label>
                    <input class="form-control" type="text" name="btitle" value="<?php echo $row['book_title']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Description</label>
                    <textarea cols="10" rows="5" name="bdesc" class="form-control"><?php echo $row['book_desc'];?></textarea>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Author</label>
                    <input class="form-control" type="text" name="bauthor" value="<?php echo $row['book_author'];?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Book Count</label>
                    <input class="form-control" type="number" name="bcount" value="<?php echo $row['book_count'];?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
