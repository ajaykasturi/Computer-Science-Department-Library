      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Computer Science Department Library RGUKT-Basar</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            <div class="card-header text-center p-0 mt-4">
              <div class="row justify-content-center">
                <img src="./admin/assets/img/logo.png" class="navbar-brand-img" style="width:17%" alt="main_logo">
                <h5></h5>
              </div>
            </div>
            <div class="card-body">
              <form role="form" action="./components/_handlelogin.php" method="post">
                <div class="mb-3">
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-success w-100 my-4 mb-2">Log In</button>
                </div>
              </form>
            </div>
          </div>
