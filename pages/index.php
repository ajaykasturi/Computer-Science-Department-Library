  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <?php
      ...
      if($numRows>0)
      {
        ...
        {
          $total+=$row['book_count'];
        }
      }
      //calculate no. of available books
      $query = "SELECT * FROM `reserve` where `status`='1';";
      $result = mysqli_query($conn, $query);
      $numRows = mysqli_num_rows($result);
      $approve = $numRows;
      $avail = $total - $numRows;
      //calculate no. pending requests
      $query = "SELECT * FROM `reserve` where `status`='0';";
      $result = mysqli_query($conn, $query);
      $numRows = mysqli_num_rows($result);
      $pending = $numRows;
      //calculate no. of return books
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Number of Books</p>
                    <h5 class="font-weight-bolder"><?php echo $total;?></h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-database-fill" viewBox="0 0 16 16">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Number of Availble Books</p>
                    <h5 class="font-weight-bolder"><?php echo $avail;?></h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-danger shadow-danger text-center rounded-circle d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-database-fill-check" viewBox="0 0 16 16">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="font-weight-bolder"><?php echo $pending;?></h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-file-earmark-arrow-down-fill" viewBox="0 0 16 16">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Approved Requests</p>
                    <h5 class="font-weight-bolder"><?php echo $approve;?></h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle d-flex align-items-center justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-file-earmark-check-fill" viewBox="0 0 16 16">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Returns</p>
                    <h5 class="font-weight-bolder"><?php echo $returned;?></h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-warning shadow-warning text-center rounded-circle d-flex align-items-center justify-content-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" class="bi bi-file-earmark-minus-fill" viewBox="0 0 16 16">
                ...
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Username</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Actions</th>
                      <th class="text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Time of request</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      if($numRows>0)
                      {
                        while($row = mysqli_fetch_assoc($result))
                        {
                          ...
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-secondary">'.$status.'</span>
                          </td>
                          <td>
