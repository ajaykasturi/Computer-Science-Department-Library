  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/postnotice.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative border-radius-lg ">
    <?php
        ...
        <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
            ...
            <strong>e-Notice posted Successfully</strong>
        ...
        //for updating notice or editing notice
        if(isset($_GET['updated']) && $_GET['updated']=="true"){
          echo '<div class="alert alert-success alert-sm alert-dismissible fade show col-sm" role="alert" id="editupdated">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="blue" class="bi bi-patch-check-fill" viewBox="0 0 16 16">
      <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
    </svg>
          <strong>e-Notice updated Successfully</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
        } else if (isset($_GET['updated']) && $_GET['updated']=="false"){
          echo '<div class="alert alert-danger alert-sm alert-dismissible fade show" role="alert" id="editupdated">
          <strong>something went wrong try again updating!</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>';
      }
      //for delete
    ...
    <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
        ...
        <strong>e-Notice deleted Successfully</strong>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>';
      } else if (isset($_GET['del']) && $_GET['del']=="false"){
        echo '<div class="alert alert-danger alert-sm alert-dismissible fade show" role="alert" id="editupdated">
        <strong>something went wrong try again deleting!</strong>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>';
    }
    ?>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">e-Notice</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Post e-Notice</h6>
        </nav>
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <!-- <img src="../assets/img/notice.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm"> -->
          ...
          <div class="card rounded-md">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Post News & Updates</p>
                <!-- <button class="btn btn-primary btn-sm ms-auto">Settings</button> -->
              </div>
            </div>
            <div class="card-body">
              <p class="text-uppercase text-sm">Enter Information</p>
              <form action="../admincomponents/_postnotice.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Heading</label>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea cols="10" rows="5" name="content" class="form-control" placeholder="Content..." required></textarea>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                ...
                <!-- <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Published By</label>
                    <input class="form-control" type="text" name="publisher" placeholder="Publisher" value="null">
                  </div>
                </div> -->
                <div class="col-md-12">
                  <div class="form-group">
                    <button class="btn btn-success ms-auto" type="submit">Post e-Notice</button>
                  </div>
                </div>
              </div>
              </form>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="myTable">
                  <thead>
                    <tr>
                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Heading</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Content</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">URL</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Date</th>
                      <th class="text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      include '../admincomponents/_dbconnect.php';
                      $query = "SELECT * FROM enotice";
                      ...
                      if($numRows>0)
                      {
                        while($row = mysqli_fetch_assoc($result))
                        {
                          echo '<tr>
                          <td>
                          <h6 class="mb-0 text-sm text-center">'.$row["id"].'</h6>
                          </td>
                          <td>
                          <h6 class="mb-0 text-sm">'.$row["heading"].'</h6>
                          </td>
                          <td>
                          <h6 class="mb-0 text-sm">'.$row["content"].'</h6>
                          </td>
                          <td class="align-middle text-center text">
                          <h6 class="mb-0 text-sm">'.$row["url"].'</h6>
                          </td>
                          <td class="align-middle text-center text">
                          <h6 class="mb-0 text-sm">'.$row["dt"].'</h6>
                          </td>
                          <td class="align-middle text">
                            <span type="button" class="badge badge-sm bg-gradient-primary edit" id='.$row["id"].'>Modify</span>
                            <span type="button" class="badge badge-sm bg-gradient-danger delete" id=d'.$row["id"].'>Remove</span>
                          </td>
                        </tr>';
                        }
                      }
      ...
      Array.from(deletes).forEach((element)=>{
        element.addEventListener('click',function(e){
          ...
          if(window.confirm("Are you sure, you want to delete this notice!")){
            ...
            formdel.method = 'post';
            formdel.action = '../admincomponents/_delnotice.php';
            ...
            formdel.submit();
            // window.location = `bookmanagement.php?delete=${sno}`;
          }
        });
      });
  </script>
