...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        ...
        <li class="nav-item">
          <a class="nav-link active " href="../pages/requestreturns.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Requests and Returns</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Pending or Approved Requests</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
                ...
                <table class="table align-items-center mb-0" id="myTable1">
                  <thead>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">User</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Request Date</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            if($row['status']=='0'){
                                ...
                                <td class="align-middle text-center text">
                                    <span class="badge badge-sm bg-gradient-success">'.$row["request_date"].'</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span type="button" class="badge badge-sm bg-gradient-primary approve" id=a'.$row["sno"].'>Approve</span>
                                    <span type="button" class="badge badge-sm bg-gradient-danger discard" id=d'.$row["sno"].'>Discard</span>
                                </td>
                                </tr>';
                            }
                        }
                ...
                <table class="table align-items-center mb-0" id="myTable2">
                  <thead>
                    ...
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      ...
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">User</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Request Date</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9 ps-2">Status</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Approval Date</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      if($numRows>0)
                      {
                        while($row = mysqli_fetch_assoc($result))
                        {
                            if($row['status']=='1'){
                                ...
                                <td class="align-middle text-center text">
                                    <span class="badge badge-sm bg-gradient-secondary">'.$row["request_date"].'</span>
                                </td>
                                <td class="align-middle text-center text">
                                    <span class="badge badge-sm bg-gradient-success">Approved</span>
                                </td>
                                <td class="align-middle text-center text">
                                    <span class="badge badge-sm bg-gradient-secondary">'.$row["approval_date"].'</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span type="button" class="badge badge-sm bg-gradient-primary bookreturns" id=r'.$row["sno"].'>Return</span>
                                </td>
                                </tr>';
                            }
                        }
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4 p-3">
            <div class="card-header pb-0">
              <h6><u>Returned Books</u></h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="myTable3">
                  <thead>
                    <tr>
                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">ID</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9 ps-2">Title</th>
                      <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-9">User</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-9">Date of request</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Date of approval</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Return Status</th>
                      <th class="text-center text-secondary text-uppercase text-xs font-weight-bolder opacity-9">Date of return</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      ...
                      if($numRows>0)
                      {
                        while($row = mysqli_fetch_assoc($result))
                        {
                          echo '<tr>
                          <td>
                          <h6 class="mb-0 text-sm">'.$row["book_id"].'</h6>
                          </td>
                          <td>
                          ...
                          <td class="align-middle text-center text">
                            <span class="badge badge-sm bg-gradient-secondary">'.$row["return_date"].'</span>
                          </td>
                        </tr>';
                        }
                      }
  ...
  <script src="approve.js" type="module"></script>
  <script src="discard.js" type="module"></script>
