  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/addadmin.php">
            <div class="icon icon-shape icon border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative border-radius-lg ">
    <?php
        ...
        <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
          ...
          } else if (isset($_GET['inserted']) && $_GET['inserted']=="false"){
            echo '<div class="alert alert-danger alert-sm alert-dismissible fade show" role="alert" id="editupdated">
            <strong>username exists or something went wrong...try again!</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
        }
    ?>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Add Admin or User</h6>
        </nav>
          ...
          <div class="card rounded-md">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Admin or User</p>
                <!-- <button class="btn btn-primary btn-sm ms-auto">Settings</button> -->
              </div>
            </div>
            <div class="card-body">
              <p class="text-uppercase text-sm">Enter Information</p>
              <form action="../admincomponents/_addadminhandler.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Select Admin or User</label>
                    <select class="form-select" name="adminuser" required>
                        <option value="" disabled selected>Select admin or user</option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <button class="btn btn-success ms-auto" type="submit">Register</button>
                  </div>
                </div>
              </div>
              </form>
