...
<body class="g-sidenav-show bg-gray-100" data-new-gr-c-s-check-loaded="14.1119.0" data-gr-ext-installed="">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Edit e-Notice</h6>
        </nav>
    ...
    <?php
      ...
      $id = $_POST['id'];
      $query = "SELECT * FROM `enotice` WHERE `id`='$id';";
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Edit e-Notice</p>
                <button class="btn btn-success btn-sm ms-auto" id="noticeEdit">EDIT</button>
              </div>
            </div>
            <div class="card-body">
              <p class="text-uppercase text-sm">e-Notice Information</p>
              <form action="../admincomponents/_editnoticehandler.php" method="post">
                <input type="hidden" value="<?php echo $id;?>" name="id">
              <div class="row">
              <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Heading</label>
                    <input class="form-control" type="text" placeholder="Heading..." name="heading" id="heading" value="<?php echo $row['heading']; ?>" required readonly>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Content</label>
                    <textarea cols="10" rows="5" name="content" class="form-control" placeholder="Content..." id="content" required readonly><?php echo $row['content']; ?></textarea>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">URL</label>
                    <input class="form-control" type="text" name="url" placeholder="URL..." value="<?php echo $row['url']; ?>" id="url" readonly>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Posted Date</label>
                    <input class="form-control" type="text" name="date" placeholder="" value="<?php echo $row['dt']; ?>" id="dt" readonly>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <button class="btn btn-success ms-auto d-none" id="aupdate" type="submit">Update e-Notice</button>
                  </div>
                </div>
              </div>
              </form>
  ...
  <script src="editnotice.js"></script>
  <script>
